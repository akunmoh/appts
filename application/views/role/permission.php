<section class="panel">
	<div class="panel-heading">
		<h4 class="panel-title"> <i class="fab fa-buromobelexperte"></i> <?php echo "Role Permission : " . get_type_name_by_id('roles', $role_id); ?></h4>
	</div>
				...
				<table class="table table-bordered table-hover table-condensed mt-sm" cellspacing="0" width="100%">
						...
						<tr>
							...
							<th>
								<div class="checkbox-replace"> 
									<label class="i-checks"><input type="checkbox" id="all_view" value="1"><i></i> Lihat</label> 
								</div>
							</th>
							<th>
								<div class="checkbox-replace"> 
									<label class="i-checks"><input type="checkbox" id="all_add" value="1"><i></i> Tambah</label> 
								</div>
							</th>
							<th>
								<div class="checkbox-replace"> 
									<label class="i-checks"><input type="checkbox" id="all_edit" value="1"><i></i> Edit</label> 
								</div>
							</th>
							<th>
								<div class="checkbox-replace"> 
									<label class="i-checks"><input type="checkbox" id="all_delete" value="1"><i></i> Hapus</label> 
								</div>
							</th>
						</tr>
					</thead>
					<tbody>
						...
						if(count($modules)){ 
							...
							?>
						<tr>
							<th colspan="5"><?php echo $module['nama']; ?></th>
						</tr>
						<?php
						...
						<tr>
							<td class="pl-xl"><i class="far fa-arrow-alt-circle-right text-md"></i> <?php echo $permission['nama']; ?></td>
							<td>
