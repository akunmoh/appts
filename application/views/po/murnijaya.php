<section class="panel">
	<header class="panel-heading">
		<?php if(get_permission('murni_jaya', 'is_add')){ ?>
		<div class="panel-btn">
		...
		<?php } ?>
		<h4 class="panel-title"><i class="fas fa-list-ul"></i> Data P.O Murni Jaya</h4>
	</header>
	<div class="panel-body">
		<div class="export_title">Laporan Data Mobil Murni Jaya</div>
		<table class="table table-bordered table-hover table-condensed table_default" cellspacing="0" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
                        <?php if (get_permission('murni_jaya', 'is_edit')): ?>
                        <a href="javascript:void(0);" class="btn btn-circle btn-default icon" data-toggle="tooltip"
                            data-original-title="Edit" onclick="EditData('<?=$row['id']?>','murnijaya');"><i class="fas fa-pen-nib"></i></a>
						<?php endif; if (get_permission('murni_jaya', 'is_delete')): ?>
