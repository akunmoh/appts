			...
			<div class="tab-pane box active" id="list">
				<?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered')); ?>
					<div class="form-group mt-xs">
						<label class="col-md-3 control-label">Password Saat Ini <span class="required">*</span></label>
						<div class="col-md-6">
					...
					<div class="form-group">
						<label class="col-md-3 control-label">Konfirmasi Password <span class="required">*</span></label>
