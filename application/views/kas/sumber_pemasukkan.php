<section class="panel">
    <header class="panel-heading">
        ...
        <h4 class="panel-title"><i class="fas fa-list-ul"></i> Data Sumber Pemasukkan</h4>
    </header>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <?php if (get_permission('sumber_kas_masuk', 'is_edit')): ?>
                        <a href="javascript:void(0);" class="btn btn-circle btn-default icon" data-toggle="tooltip"
                            data-original-title="Edit" onclick="EditSumberPem('<?=$row['id']?>');"><i class="fas fa-pen-nib"></i></a>
                        <?php endif; if (get_permission('sumber_kas_masuk', 'is_delete')): ?>
                        <?=btn_delete('kas/sumber_pemasukkan_delete/' . $row['id']); ?>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php
    ...
    <section class="panel">
        <div class="panel-heading">
            <h4 class="panel-title">
                <i class="far fa-plus-square"></i> Tambah Sumber Pemasukkan
            </h4>
        </div>
        ...
        <footer class="panel-footer">
            <div class="text-right">
                <button type="submit" name="submit" value="pemasukkan" class="btn btn-default">Simpan</button>
...
<div class="zoom-anim-dialog modal-block modal-block-primary mfp-hide" id="EditSumberPem">
