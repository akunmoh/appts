		...
		<div class="row mb-sm">
			<div class="col-md-offset-3 col-md-3 mb-sm">
				<div class="form-group">
					<label class="control-label">Sumber Pemasukkan</label>
					<?php
...
<section class="panel">
	<header class="panel-heading">
		<h4 class="panel-title"><i class="fas fa-list-ul"></i> Laporan Kas Masuk</h4>
	</header>
	<div class="panel-body">
		<div class="export_title">Laporan Kas Masuk</div>
		<table class="table table-bordered table-hover table-condensed table-export" cellspacing="0" width="100%"
			...
			<tbody>
                ...
                <?php $total_dr = 0; $count = 1; if (!empty($pemasukkan)){ foreach ($pemasukkan as $row): $total_dr += $row['nominal']; ?>
				<tr>
			...
			<tfoot>
				<tr>
					<th colspan="6" class="text-right"><b>Total Pemasukkan :</b></th>
					<th class="text-right">Rp <?=number_format($total_dr, 0, '.', ','); ?></th>
				</tr>
			</tfoot>
		</table>
	</div>
