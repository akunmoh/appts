...
<body class="loading-overlay-showing" data-loading-overlay>
	...
	<section class="body">
		...
		<div class="inner-wrapper">
			<!-- sidebar -->
			<?php 
			// if (is_gudang_loggedin() || is_posj_loggedin()) {
			...
			<section role="main" class="content-body">
				<header class="page-header">
					<a class="page-title-icon" href="<?php echo base_url('beranda');?>"><i class="fas fa-home"></i></a>
	...
	<script type="text/javascript">
		function confirm_modal(delete_url) {
			swal({
				...
				buttonsStyling: false,
				footer: "Data yang terhapus tidak dapat di kembalikan"
			}).then((result) => {
				if (result.value) {
					$.ajax({
						url: delete_url,
