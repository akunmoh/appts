						...
						<div class="panel-body">
							<div class="row widget-col-in">
								...
								<div class="col-md-4 col-sm-4 col-xs-4">
									<h3 class="counter text-right mt-md text-primary"><?= $tot_pnp2['total_pnp'];?></h3>
								</div>
						...
						<div class="panel-body">
							<div class="row widget-col-in">
								...
								<div class="col-md-8 col-sm-8 col-xs-8">
									<h3 class="counter text-right mt-md text-primary"><?= $tot_bus2;?></h3>
								</div>
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="box-top-line line-color-primary">
					...
					<div class="col-lg-3 col-sm-6 ">
						<div class="panel-body">
							<div class="row widget-col-in">
								...
								<div class="col-md-8 col-sm-8 col-xs-8">
									<h3 class="counter text-right mt-md text-primary"><?= $barat2;?></h3>
								</div>
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="box-top-line line-color-primary">
					...
					<div class="col-lg-3 col-sm-6 ">
						<div class="panel-body">
							<div class="row widget-col-in">
								...
								<div class="col-md-8 col-sm-8 col-xs-8">
									<h3 class="counter text-right mt-md text-primary"><?= $timur2;?></h3>
								</div>
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="box-top-line line-color-primary">
				...
				<div class="panel-body">
					<div class="table-responsive">
						<table class="table table-bordered table-hover table-condensed" cellspacing="0" width="100%">
							...
							<tbody>
								<?php $count = 1; if (!empty($data_bus2)){ foreach ($data_bus2 as $row): ?>
								<tr>
