...
// GUDANG JS
function getKategoriBarang(id) {
    $.ajax({
        url: base_url + 'ajax/kategori_barang',
        type: 'POST',
        data: {'id': id},
        dataType: "json",
...
function grandTotalCalculatePur() {
	var netQTYTotal = 0;
	$(".qty_barang").each(function() {
		netQTYTotal += read_number(this.value)
	});
	$("#netQTYTotal").val(netQTYTotal.toFixed(0));

	var totalQTY = 0;
	$(".qty_barang").each(function() {
		totalQTY += read_number(this.value)
	});
...
$("#frmEditSubmit").on('submit', (function (e) {
	e.preventDefault();
	var btn = $("#updatebtn");
	btn.button('loading');
	$.ajax({
...
function EditKategori(id) {
    $.ajax({
        url: base_url + 'gudang/kategori_edit',
        type: 'POST',
        data: {
            kategori_id: id
        },
...
function getBarangByKategori(kategori_id, barang_id) {
	if (kategori_id != "") {
		$.ajax({
			type: "POST",
			url: base_url + 'ajax/get_barang_by_kategori',
			data: {
...
function EditLokasi(id) {
    $.ajax({
        url: base_url + 'pegawai/lokasi_edit',
        type: 'POST',
        data: {
            lokasi_id: id
        },
...
function EditJabatan(id) {
    $.ajax({
        url: base_url + 'pegawai/jabatan_edit',
        type: 'POST',
        data: {
            jabatan_id: id
        },
...
function EditShift(id) {
    $.ajax({
        url: base_url + 'pegawai/shift_edit',
        type: 'POST',
        data: {
            shift_id: id
        },
...
function EditMasuk(id) {
    $.ajax({
        url: base_url + 'gudang/barangmasuk_edit',
        type: 'POST',
        data: {
            barang_id: id
        },
...
function EditKeluar(id) {
    $.ajax({
        url: base_url + 'gudang/barangkeluar_edit',
        type: 'POST',
        data: {
            id: id
        },
        ...
        success: function (data) {
            $('#view').html(data);
            mfp_modal('#EditKeluar');
        }
    });
}

// KEUANGAN JS (KAS)
function KasMasuk(id) {
    $.ajax({
        url: base_url + 'kas/pemasukkan_edit',
        type: 'POST',
        data: {
            id: id
        },
...
function KasKeluar(id) {
    $.ajax({
        url: base_url + 'kas/pengeluaran_edit',
        type: 'POST',
        data: {
            id: id
        },
...
function EditSumberPem(id) {
    $.ajax({
        url: base_url + 'kas/sumber_pemasukkan_edit',
        type: 'POST',
        data: {
            id: id
        },
        ...
        success: function (data) {
            $('#view').html(data);
            mfp_modal('#EditSumberPem');
        }
    });
}
function EditSumber2(id) {
    $.ajax({
        url: base_url + 'kas/sumber_pengeluaran_edit',
        type: 'POST',
        data: {
            id: id
        },
        ...
        success: function (data) {
            $('#view').html(data);
            mfp_modal('#EditSumber2');
        }
    });
}

// PENGGAJIAN
function hitungGaji(bulan,tahun,id) {
    $.ajax({
        url: base_url + 'penggajian/hitung',
        type: 'POST',
        data: {
			id: id,
			bulan: bulan,
        ...
        success: function (data) {
            $('#view').html(data);
            mfp_modal('#hitungGaji');
        }
    });
}
function bayarGaji(id,bulan,tahun) {
    $.ajax({
...
function slipGaji(id) {
    $.ajax({
        url: base_url + 'penggajian/slipgaji',
        type: 'POST',
        data: {
			id: id,
        },
